...
public class AndroidPushMessageController {
    ...
    public void android(HttpServletRequest request, HttpServletResponse resp)
	    throws ServletException, IOException {
	final String postUrl = "https://android.googleapis.com/gcm/send";// put
	// in
	// your
	// url
	...
	final StringEntity postingString = new StringEntity(gson.toJson(data));// convert
	// your
	// pojo
	// to
	// json
	...
	try {
	    ...
	    // String
	    // regId="APA91bEkrLwkKOluOQiWEXn4g5eImNweVeu3oxCk6JTzi4lZM6FLzRzrpjCszn-8Gy9g0h9YXDG45R0SS3G9Aij0XkfklP172wgSaV86aOLWS82a2j9-xYWEXTM2-fx9UxQMvRkOL8-pW6oUfRqkeMz5zyU6KrlPLg";
    ...
    public void GCMNotificationPost(HttpServletRequest request,
	...
	if ("shareRegId".equalsIgnoreCase(action)) {
	    ...
	    request.getRequestDispatcher("/WEB-INF/views/GCMNotification.jsp")
		...
		final AndroidPushMsg msg = cust
			.getAndroidPushMsgByEmail(toName);
		...
		final MulticastResult multiResult = sender.send(message,
			regIdList, 1);
    ...
    public String GCMNotificationPostGet(HttpServletRequest request,
	    HttpServletResponse response) throws ServletException, IOException {
    ...
    public void GCMNotificationRegister(HttpServletRequest request,
	    HttpServletResponse response) throws ServletException, IOException {
    ...
    public void regIdDelete(HttpServletRequest request,
	    HttpServletResponse response) throws ServletException, IOException {
	final String reg = request.getParameter("regId");
