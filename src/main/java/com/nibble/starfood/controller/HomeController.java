	 ...
	 */
	 @RequestMapping(value = "/getMachedNames.web", method =RequestMethod.GET)
		  ...
		  for(Area list:city)
		  {
			  ...
			  System.out.println(list.getAreaDesc());
	 ...
	 @RequestMapping(value = "/mobile/getAddressById", method = RequestMethod.POST, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
		public @ResponseBody Object getAddressUsingId(@RequestBody final IdDet id) {
			...
			if (addrs.size() != 0) {
				for (final Address addr : addrs) {
					if (addr.getAddrTypeId() == 1) {
						System.out.println("addtypidhome  "
								+ addr.getAddrTypeId());
						addresslist.add(addr);

					} else if (addr.getAddrTypeId() == 2) {
						System.out.println("addtypidoffice  "
								+ addr.getAddrTypeId());
						addresslist.add(addr);
		...
		public @ResponseBody Object contactUs(@RequestBody  CustomerComplaintsMail contactDet) {
	 ...
	 @RequestMapping(value = "/viewArea", method = RequestMethod.GET, produces = "application/json")
	    public  @ResponseBody String  viewAbondonedOrdersbasedonDatePagination(HttpServletRequest  request) {
...
//	     pagedList.resort();
	 ...
	 public  @ResponseBody List<City>  getawMatSubCatg(HttpServletRequest  request) {
	...
	public @ResponseBody String jqueryTest(Locale locale, Model model) {
		logger.info("Welcome home! The client locale is {}.", locale);
	...
	public @ResponseBody Object getDate(Locale locale, Model model) {
		logger.info("Welcome home! The client locale is {}.", locale);
	...
	public @ResponseBody  String test(Locale locale, Model model) {
		logger.info("Welcome home! The client locale is {}.", locale);
	...
	public @ResponseBody List<City> showList(@ModelAttribute("rawMaterial") City rawMaterial,BindingResult errors)
			   {
	...
	public @ResponseBody Object custCupons(@RequestBody final Id id) {
	...
	public @ResponseBody Object pincodeList() {
		Map<String, Object> map=new HashMap<String, Object>();
	...
	public @ResponseBody Object areaList() {
	...
	public @ResponseBody Object payMod(@RequestBody FeedBackWrapper feed) {
	...
	public @ResponseBody Object getFeedBackQuery(@RequestBody final FeedBackQuery feedbackQuery) {
		final Map<String, Object> map = new HashMap<String, Object>();
		 
		  final List<FdbkQues> queryList= cust.getFeedBackQuerys();
		 // String json = new Gson().toJson(cityList);Fupdate
	...
	public @ResponseBody Object getCityList(@RequestBody final CitsInputName cityname) {
		final Map<String, Object> map = new HashMap<String, Object>();
	 ...
	 public @ResponseBody Object register(@RequestBody final CustomerRegistration register) {
	 ...
	 @RequestMapping(value = "/mobile/changePassword", method = RequestMethod.POST)
		public @ResponseBody HashMap<String, Object> changePassword(@RequestBody final CustomerRegistration register) {
		 final HashMap<String, Object> map = new HashMap<String, Object>();
		  CustDet customer;
	 ...
	 @RequestMapping(value = "mobile/changepassword", method = RequestMethod.POST)
		public @ResponseBody Object sign(@RequestBody final ChangePassword changePass) {
	...
	/* @RequestMapping(value = "/mobile/login", method = RequestMethod.POST, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
	 public @ResponseBody Object login(@RequestBody final CustomerRegistration register) {
	  ...
	  /*  final List<Address> addrs= cust.getAddressList(id.getId());
	    ...
	    public @ResponseBody Map<String, Object> price(@RequestBody final FoodCat singleDayMenu) {
	 ...
	 @RequestMapping(value = "/mobile/FBsign", method = RequestMethod.POST, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
		public @ResponseBody Object sfbLogin(@RequestBody final FBLogin fb) {
	 ...
	 @RequestMapping(value = "/mobile/GplusSave", method = RequestMethod.POST, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
		public @ResponseBody Object saveGPlus(@RequestBody final GpSave gp) {
	 ...
	 @RequestMapping(value = "/mobile/EOrderClientDet", method = RequestMethod.GET)
		public @ResponseBody Object clientDetails() {
	 ...
	 @RequestMapping(value = "/mobile/forgotpassword", method = RequestMethod.POST)
		public @ResponseBody HashMap<String, Object> forgotPassword(@RequestBody final ForgotPassword forgotPassword) {
			final HashMap<String, Object> map = new HashMap<String, Object>();
			CustDet customer;
	 ...
	 @RequestMapping(value = "/mobile/verfuserotp", method = RequestMethod.POST)
		public @ResponseBody HashMap<String, Object> verifOTP(@RequestBody final OTPGeneration otpgen) {
			final HashMap<String, Object> map = new HashMap<String, Object>();
			CustDet customer;
	 ...
	 @RequestMapping(value = "/mobile/savemobileotp", method = RequestMethod.POST)
		public @ResponseBody HashMap<String, Object> saveMobileAndOTP(@RequestBody final OTPGeneration otpgen) {
			final HashMap<String, Object> map = new HashMap<String, Object>();
			CustDet customer;
			...
			if (!otpgen.getMobile().isEmpty()) {
				 CustDet custorderdet;
				 customer=cust.updatePhoneOTP(otpgen);
				//customer = cust.VerfPhone(otpgen.getOtp());
				if (customer != null) {
	 ...
	 @RequestMapping(value = "/mobile/generateotp", method = RequestMethod.POST)
		public @ResponseBody HashMap<String, Object> generateOTP(@RequestBody final OTPGeneration otpgen) {
			final HashMap<String, Object> map = new HashMap<String, Object>();
			CustDet customer;
			CustDet custma;
			...
			if (!otpgen.getMobile().isEmpty() && !otpgen.getOtp().isEmpty()) {
				...
				if (custma == null) {
					...
					map.put("status","success" );
					sendExotelSMS(otpgen.getMobile(),otpgen.getOtp()); // SMS Triggering for ForgotPassword
					return map;
				}
	...
	/* @RequestMapping(value = "/mobile/updateAddress", method = RequestMethod.POST, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
	 ...
	 @RequestMapping(value = "/mobile/foodItemByarea", method = RequestMethod.POST)
		public @ResponseBody Object getFoodTypeId(@RequestBody final Id id) {
	...
	/*	
	 ...
	 @RequestMapping(value = "/mobile/getAddressId", method = RequestMethod.POST,produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
		public @ResponseBody Object getAddressId(@RequestBody final Id id) {
	...
	/* @RequestMapping(value = "/mobile/getAddressWithId", method = RequestMethod.POST,produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
	 ...
	 @RequestMapping(value = "mobile/getAddressWithId", method = RequestMethod.POST, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
		public @ResponseBody Object getAddressWithId(@RequestBody final Id addressDet) {
	 ...
	 @RequestMapping(value = "/mobile/updateAddress", method = RequestMethod.POST, produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
	 public @ResponseBody Object updateAddress(@RequestBody final AddressOut addressout) {
		 final HashMap<String, Object> map = new HashMap<String, Object>();
	 ...
	 public @ResponseBody Object addrDefaultFlagId(@RequestBody final AddressFlag addresflag) {
		 final HashMap<String, Object> map = new HashMap<String, Object>();
	 ...
	 @RequestMapping(value = "/mobile/getOtherAddressWithId", method = RequestMethod.POST,produces = { MediaType.APPLICATION_JSON_VALUE }, consumes = { MediaType.APPLICATION_JSON_VALUE })
		public @ResponseBody Object getOtherAddressWithId(@RequestBody final Id id) {
	 ...
	 public @ResponseBody Object addrDefaultFlag(@RequestBody final AddressFlag addresflag) {
		 final HashMap<String, Object> map = new HashMap<String, Object>();
		...
		public  @ResponseBody Map<String, Object> reviewsave(@RequestBody  final Cust custs) {
		 final HashMap<String, Object> map = new HashMap<String, Object>();
			CustDet customer;
	 ...
	 */
	 ...
	 public String sendExotelSMS(String cntcNo, String password) {
			...
			String url = "https://" + authStr + "@twilix.exotel.in/v1/Accounts/"
					+ sid + "/Sms/send";
	 ...
	 public  void forgotPasswordSendEmail(ForgotPassword forgotPassword, String password, String cntcName){
		...
		//  final String FROM = "info@spicebox.in"; 
		  ...
		  final String TO = forgotPassword.getEmail();  // I have production access
