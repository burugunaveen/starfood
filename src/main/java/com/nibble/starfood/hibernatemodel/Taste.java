...
/**
 * Taste generated by hbm2java
 */
@Entity
@Table(name = "taste", catalog = "starfoodlocal")
public class Taste implements java.io.Serializable {
	...
	public Taste(String tasteDesc, Date crtTs, Date updTs, String crtId) {
	...
	@Column(name = "taste_desc", nullable = false, length = 100)
