...
public class OrderController {
    ...
    public Map<String, Object> menuList(@RequestBody final GetFoodItems fooditems) {
        final Map<String, Object> map = new HashMap<String, Object>();
        final List<Map<String, Object>> ordersList = new ArrayList<Map<String, Object>>();
//        System.out.println("meal plan type is subscription");//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
        List<PkgSizTyp> count = cust.getPackageCount();
        List<PkgSizTyp> menuList = cust.getPackagesMenuList(fooditems);
//        System.out.println("MenuList size:" + menuList.size());//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
...
//            //orderJson.put("online charge",pkg.getOnlinePayChrg());//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
...
//        int mealPlanId = 1;//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
        int dinnerTimeId = 2;
        for (int i = 1; i <= 2; i++) {
            final Map<String, Object> map = new HashMap<String, Object>();
            int mealTimeId = i;
...
//                map.put("date", df.format(calendr.getTime()));//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                map.put("day", currentDay.format(calendr.getTime()));
//                map.put("holidayDesc", holidays.getHolidayDesc());//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                map.put("key", "5");
                ...
                if (day == Calendar.SUNDAY) {
                    ...
                    if (inputDt.equals(indianCurrentDate)) {
                        //                        DateFormat dateintimeformat = new SimpleDateFormat("hh:mm a");//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                    ...
                    if (isBefore == true) {
                        ...
                        if (dayName == Calendar.SATURDAY) {
                            //                            System.out.println("days are matching");//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                            calndr.add(Calendar.DATE, 2);
                            //                            System.out.println(dtformat.format(calndr.getTime()));//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
    ...
    public Map<String, Object> price1(@RequestBody final GetFoodItems fooditems) {
        ...
        //        DateFormat df = new SimpleDateFormat("yyyy-MM-dd");//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
        DateFormat currentDay = new SimpleDateFormat("EEEE");
        int day = calendr.get(Calendar.DAY_OF_WEEK);
        if (fooditems.getMealPlanId() == 2) {
            ...
            for (PkgSizTyp pkg : menuList) {
                ...
                //orderJson.put("mealTimeDetails",pkg.getMealtime());
                //                orderJson.put("tax", pkg.getTax());//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
            ...
            if (ordersList.size() != 0) {
                //                map.put("PkgItemList", ordersList);//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                map.put("status", "success");
                map.put("key", "1");
            ...
            //            calendr.add(Calendar.DATE, 1);//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
            System.out.println(df.format(calendr.getTime()));
            map.put("date", df.format(calendr.getTime()));
            map.put("day", currentDay.format(calendr.getTime()));
            ...
            if (day == Calendar.SUNDAY) {
                ...
                if (inputDt.equals(indianCurrentDate)) {
                    ...
                    try {
                        ...
                        currenttime = dateintimeformat.parse(getIndianTimeWithStringForMealTime());
                        System.out.println(currenttime + "for forLunch");
                    //                        System.out.println(cutofftimeindate + "forLunch");//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                    } catch (ParseException e) {
                        e.printStackTrace();
                    }
                    if (cutofftimeindate.getTime() - currenttime.getTime() > 0) {
		   ...
		   */
                ...
                if (isBefore == true) {
                    ...
                    for (PkgSizTyp pkg : menuList) {
                        ...
                        //List<PkgConfigRelt> foodItems=cust.getItemsBasedOnPackage(pkg.getId(),fooditems.getDates());
                        List<PkgConfigRelt> foodItems = cust.getItemsBasedOnPackageMealTime(pkg.getId(), fooditems.getDates(), fooditems.getMealTime());
                        //                        final List<Map<String, Object>> itemList = new ArrayList<Map<String, Object>>();//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                        List<String> packageItems = new ArrayList<String>();
                        //                        final Map<String, Object> itemmap = new HashMap<String, Object>();//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                        String desc = "";
                        for (PkgConfigRelt pkgsitems : foodItems) {
                            if (desc != "") {
                            //                                desc = desc + ",";//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                            }
                            //final Map<String, Object> itemmap = new HashMap<String, Object>();
                    ...
                    /*for(PkgConfigRelt pkgs:foodItems)
		{
			...
			orderJson1.put("ItemImage",pkgs.getItems().getImage());
                    ...
                    if (ordersList.size() != 0) {
                        ...
                        map.put("status", "success");
                        map.put("key", "1");
                        //                        map.put("deliverycharge", menuList.get(0).getDelvChrg().getDelvChrg());//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                        map.put("onlinecharge", menuList.get(0).getOnlinePayChrg());
                    } else {
                        map.put("status", "menu not found");
                        map.put("key", "3");
    ...
    public Map<String, Object> price(@RequestBody final GetFoodItems fooditems) {
        ...
        if (fooditems.getMealPlanId() == 2) {
            System.out.println("meal plan type is subscription");
            //            //List<PkgSizTyp> count=cust.getPackageCount();//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
            List<PkgSizTyp> menuList = cust.getPackagesMenuList(fooditems);
            for (PkgSizTyp pkg : menuList) {
                final Map<String, Object> orderJson = new HashMap<String, Object>();
                orderJson.put("package id", pkg.getId());
                ...
                if (fooditems.getPriceDurationId() == 2) {
                //			orderJson.put("price",pkg.getPkgPrice().getoneWeekPrice());//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                }
                if (fooditems.getPriceDurationId() == 3) {
                    orderJson.put("price", pkg.getPkgPrice().getoneMonthPrice());
                }
                if (fooditems.getPriceDurationId() == 4) {
                //			orderJson.put("price",pkg.getPkgPrice().getThreedaysPrice());//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                }
                if (fooditems.getPriceDurationId() == 0) {
                //			orderJson.put("packageprice",pkg.getPkgPrice());//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                }
                //orderJson.put("mealTimeDetails",pkg.getMealtime());
                orderJson.put("tax", pkg.getTax());
                orderJson.put("food type", pkg.getFoodtyp());
		...
		isBefore = givenDate.before(cancelCutOffTime);
		   */
			...
			packageItems.add(pkgsitems.getItems().getFoodItmNameEn());*/
                    ...
                    /*for(PkgConfigRelt pkgitems:foodItems)
		{  final Map<String, Object> orderJson1 = new HashMap<String, Object>();
//		    final Map<String, Object> orderJson2 = new HashMap<String, Object>();//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
			orderJson1.put("itemId",pkgitems.getItems().getId());
			orderJson1.put("itemName",pkgitems.getItems().getFoodItmNameEn());
			orderJson1.put("ItemImage",pkgitems.getItems().getImage());
			orderJson2.put("ItemDetails", orderJson1);
	...
	public @ResponseBody Map<String, Object> pricelist(@RequestBody final MenuList menu) {
		...
		//foodlist.put("packages available", menuList);
//		for (PkgSizTyp menuLst : menuList) {//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
			final Map<String, Object> orderJson = new HashMap<String, Object>();
...
//				if(menuLst.getPkgDurId()==1){//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
				//orderJson.put("Package Price", menuLst.getPkgPrice().getoneDayPrice());
				}
				else if(menuLst.getPkgDurId()==2){
				//	orderJson.put("Package Price", menuLst.getPkgPrice().getoneWeekPrice());
    ...
    public Map<String, Object> mealPlanIos() {
        ...
        for (PkgSizTyp pkg : pkgconfig) {
            ...
            //	           cal.add(Calendar.DATE, 0); //minus number would decrement the days//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
            ...
            //	          //map.put("dates",foodItems.getMenuDate());//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
            for (int i = 0; i < 7; i++) {
                ...
                //	        calendar.add(Calendar.DATE, i); //minus number would decrement the days//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                ...
                List<String> packageItems = new ArrayList<String>();
                String foodItemsDet = "";
                //		for(PkgConfigRelt pkgsitems:foodItems)//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                {
                    if (pkgsitems.getMenuDate().equals(todayDate)) {
                        //  packageItems.add(pkgsitems.getItems().getFoodItmNameEn());
                        foodItemsDet = foodItemsDet + pkgsitems.getItems().getFoodItmNameEn() + ",";
                    }
                //This Line is modifided by VioFixer as a fix for Poor Error Handling: Empty Catch Block
                }
    ...
    public Map<String, Object> mealPlan() {
        ...
        for (PkgSizTyp pkg : pkgconfig) {
            ...
            final List<Map<String, Object>> itemList = new ArrayList<Map<String, Object>>();
            //	     Calendar cal = Calendar.getInstance();//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
            try {
                cal.setTime(sdf.parse(date));
            } catch (ParseException e) {
                // TODO Auto-generated catch block
    ...
    public Map<String, Object> mealPlanForPortal() {
        ...
        for (PkgSizTyp pkg : pkgconfig) {
            ...
            for (int i = 0; i < 7; i++) {
                ...
                //		List<String> strings1 = new ArrayList<String>();//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
    ...
    public Map<String, Object> mealPlanForPortalExtension() {
        ...
        for (PkgSizTyp pkg : pkgconfig) {
            ...
            for (int i = 0; i < 6; i++) {
                ...
                //		itemmap.put("packgeItemDeatils", packageItems);//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
                String foodItemsDet = "";
                for (PkgConfigRelt pkgsitems : foodItemsListForLunch) {
                    if (pkgsitems.getMenuDate().equals(todayDate)) {
                        foodItemsDet = foodItemsDet + pkgsitems.getItems().getFoodItmNameEn() + ",";
    ...
    public Object dataDetails() {
        ...
        try {
            ...
            // TODO VioFixer-System Information Leak: Logger not declared in the class
            e.printStackTrace();
        }
        ...
        //     // list.put("Coupon Details",cupanList);//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
        //      list.put("Payment Gate Way",cust.getPaymentGateWay());//This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
        //	  //This Line is commented by Viofixer as a fix for Poor Logging Practice Use of a System Output Stream 
        ...
        if (i == 1) {
            ...
            if (custOrderDetails.size() != 0) {
                for (CustOrdDet orderDetails : custOrderDetails) {
                    ...
                    //+ "\n" + "Order Id: " + orderDetails.getId() + "\n"
                    messageOrderDetBody = messageOrderDetBody + "Details of Package No. " + j + ": " + "\n" + "Meal Time: " + orderDetails.getMealTime().getMealTimeDesc() + "Start Date: " + orderDetails.getOrdStDt() + "\n" + "End Date: " + orderDetails.getOrdEndDt() + "\n\n";
                    //+ "\n" + "Order Id: " + orderDetails.getId() + "\n"
